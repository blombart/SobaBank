...
--Creation de l'agent--
INSERT INTO `sbdb`.`user` (`type`, `id`, `email`, `mdp`, `nom`, `prenom`, `role`, `dateDebutContrat`, `matricule`, `numTel`, `adresse`, `isClient`, `nbEnfants`, `situationMatrimonial`) VALUES ('Agent', 2, 'lombart@mail.com', '1234', 'Lombart', 'benjamin', 'agent', '2018-02-01 00:00:00', 'A002', NULL, NULL, NULL, NULL, NULL),('Agent', 5, 'sta@mail.com', '1234', 'Sta', 'Omar', 'agent', '2018-02-11 00:00:00', 'A005', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `sbdb`.`demandeouverturecompte` (`id`, `Status`, `dateAffectation`, `dateDemande`, `idClient`, `isAffected`, `isValid`) VALUES (1, 'Non traitee', NULL, '2018-02-21 00:00:00', '3', b'0', NULL);
...
--Creation de compte --
INSERT INTO `sbdb`.`compte` (`type_compte`, `id`, `dateCreation`, `decouvertAutorise`, `numCompte`, `rib`, `solde`, `tauxAgios`, `montantRemu`, `tauxInteret`) VALUES ('Compte', 1, '2018-02-01 00:00:00', '0', '0001', 'Fr2154658794456521', '500', '10', NULL, NULL);
INSERT INTO `sbdb`.`compte` (`type_compte`, `id`, `dateCreation`, `decouvertAutorise`, `numCompte`, `rib`, `solde`, `tauxAgios`, `montantRemu`, `tauxInteret`) VALUES ('CompteEpargne', 2, '2017-05-17 00:00:00', '0', '0002', 'Fr2154658756458481', '1500', '0', '500', '13');
...
--Creation de demande
INSERT INTO `sbdb`.`demande` (`type_demande`, `id`, `dateDemande`, `libelle`, `status`, `newCompte_id`) VALUES ('chequier', '1', '2018-02-08 00:00:00', 'demande de chequier', 'Non traitee', NULL),('chequier', '2', '2018-02-06 00:00:00', 'demande de chequier', 'Traitee', NULL);
